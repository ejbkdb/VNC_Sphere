...
neutral_zone = False
k = 1/23. #1/46
integral = 1/1000. #1/10852
derivative = 1/250 #1/100. #1/20
lastDistance = 0.
...
def get_heading_and_distance():
    ...
    if not neutral_zone and distance < 300:
        neutral_zone = True
...
def proportional_control():
    global blue_twist, accumulated_error, k, integral, lastDistance
    ...
    if blue_center != Point():
        ...
        speed = (distance * k) - (accumulated_error * integral) + ((distance - lastDistance) * derivative)
